...
class BlinkyEtherCube
{
  ...
  public:
    ...
    void          setMqttTray(String box, String mqttTrayType, String mqttTrayName);
...
void BlinkyEtherCube::setMqttTray(String box, String mqttTrayType, String mqttTrayName)
{
  g_mqttClientId = g_mqttUsername + "-" + mqttTrayType + "-" + mqttTrayName;
  g_mqttPublishTopic = box + "/cube/" + mqttTrayType + "/" + mqttTrayName + "/reading";
  g_mqttSubscribeTopic = box + "/cube/" + mqttTrayType + "/" + mqttTrayName + "/setting";
}
